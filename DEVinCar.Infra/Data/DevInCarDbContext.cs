...
public class DevInCarDbContext : DbContext
{
    ...
    public DevInCarDbContext() { }

    public DevInCarDbContext(DbContextOptions options) : base(options) { }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            optionsBuilder.UseSqlServer(
                "Server=localhost\\SQLEXPRESS01;Database=BD_CAR;Trusted_Connection=True;"
            );
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<City>(entity =>
        {
            ...
            entity.Property(a => a.StateId).HasColumnType("int").IsRequired();
            entity
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(u => u.Password).HasMaxLength(50).IsRequired();

            entity.Property(u => u.Name).HasMaxLength(255).IsRequired();

            entity.Property(u => u.BirthDate);

            entity.Property(u=>u.Role).HasMaxLength(15).IsRequired();
        ...
        modelBuilder.Entity<Car>(entity =>
        {
            ...
            entity.Property(c => c.SuggestedPrice).HasPrecision(18, 2);
            entity.HasData(
                new[]
                {
        ...
        modelBuilder.Entity<Sale>(entity =>
        {
            ...
            entity.Property(s => s.Id).HasColumnType("int");

            entity.Property(s => s.SaleDate);

            entity.HasOne(u => u.UserBuyer).WithMany().HasForeignKey(u => u.BuyerId);

            entity.HasOne(u => u.UserSeller).WithMany().HasForeignKey(u => u.SellerId);
        });
        ...
        modelBuilder.Entity<SaleCar>(entity =>
        {
            ...
            entity.Property(sc => sc.Id).HasColumnType("int");

            entity.Property(sc => sc.SaleId).HasColumnType("int").IsRequired();

            entity.Property(sc => sc.CarId).HasColumnType("int").IsRequired();

            entity.Property(sc => sc.UnitPrice).HasPrecision(18, 2);

            entity.Property(sc => sc.Amount).HasColumnType("int");

            entity.HasOne<Car>(c => c.Car).WithMany(c => c.Sales).HasForeignKey(c => c.Id);

            entity.HasOne<Sale>(s => s.Sale).WithMany(c => c.Cars).HasForeignKey(s => s.Id);
        });
        ...
        modelBuilder.Entity<Delivery>(entity =>
        {
            ...
            entity.Property(d => d.AddressId).HasColumnType("int");

            entity.Property(d => d.SaleId).HasColumnType("int");
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            ...
            entity
                .HasOne<City>(address => address.City)
        ...
        modelBuilder.Entity<State>(entity =>
        {
            ...
            entity.Property(s => s.Initials).HasMaxLength(2).IsRequired();
